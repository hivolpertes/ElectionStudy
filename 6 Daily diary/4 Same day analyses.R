...
# NA
lmer(NA_agg ~ DailyNews + DayWeek.d + NA_agg_prevDay + (1|SubID), data = dat) %>% summary()

lmer(NA_agg ~ DailyNews * Discrim_1.d + DayWeek.d + NA_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(NA_agg ~ DailyNews * Discrim_2.d + DayWeek.d + NA_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(NA_agg ~ DailyNews * Discrim_3.d + DayWeek.d + NA_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(NA_agg ~ DailyNews * Discrim_4.d + DayWeek.d + NA_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(NA_agg ~ DailyNews * Discrim_5.d + DayWeek.d + NA_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(NA_agg ~ DailyNews * Discrim_6.d + DayWeek.d + NA_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(NA_agg ~ DailyNews * Discrim_7.d + DayWeek.d + NA_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(NA_agg ~ DailyNews * Discrim_all.d + DayWeek.d + NA_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(NA_agg ~ DailyNews * Discrim_all_norum.d + DayWeek.d + NA_agg_prevDay + (1|SubID), data = dat) %>% summary()

# PA
lmer(PA_agg ~ DailyNews + DayWeek.d + PA_agg_prevDay + (1|SubID), data = dat) %>% summary()

lmer(PA_agg ~ DailyNews * Discrim_1.d + DayWeek.d + PA_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(PA_agg ~ DailyNews * Discrim_2.d + DayWeek.d + PA_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(PA_agg ~ DailyNews * Discrim_3.d + DayWeek.d + PA_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(PA_agg ~ DailyNews * Discrim_4.d + DayWeek.d + PA_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(PA_agg ~ DailyNews * Discrim_5.d + DayWeek.d + PA_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(PA_agg ~ DailyNews * Discrim_6.d + DayWeek.d + PA_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(PA_agg ~ DailyNews * Discrim_7.d + DayWeek.d + PA_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(PA_agg ~ DailyNews * Discrim_all.d + DayWeek.d + PA_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(PA_agg ~ DailyNews * Discrim_all_norum.d + DayWeek.d + PA_agg_prevDay + (1|SubID), data = dat) %>% summary()

# Anx
lmer(Anx_agg ~ DailyNews + DayWeek.d + Anx_agg_prevDay + (1|SubID), data = dat) %>% summary()

lmer(Anx_agg ~ DailyNews * Discrim_1.d + DayWeek.d + Anx_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(Anx_agg ~ DailyNews * Discrim_2.d + DayWeek.d + Anx_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(Anx_agg ~ DailyNews * Discrim_3.d + DayWeek.d + Anx_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(Anx_agg ~ DailyNews * Discrim_4.d + DayWeek.d + Anx_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(Anx_agg ~ DailyNews * Discrim_5.d + DayWeek.d + Anx_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(Anx_agg ~ DailyNews * Discrim_6.d + DayWeek.d + Anx_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(Anx_agg ~ DailyNews * Discrim_7.d + DayWeek.d + Anx_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(Anx_agg ~ DailyNews * Discrim_all.d + DayWeek.d + Anx_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(Anx_agg ~ DailyNews * Discrim_all_norum.d + DayWeek.d + Anx_agg_prevDay + (1|SubID), data = dat) %>% summary()


# Dep
lmer(Dep_agg ~ DailyNews + DayWeek.d + NA_agg_prevDay + (1|SubID), data = dat) %>% summary()

lmer(Dep_agg ~ DailyNews * Discrim_1.d + DayWeek.d + Dep_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(Dep_agg ~ DailyNews * Discrim_2.d + DayWeek.d + Dep_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(Dep_agg ~ DailyNews * Discrim_3.d + DayWeek.d + Dep_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(Dep_agg ~ DailyNews * Discrim_4.d + DayWeek.d + Dep_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(Dep_agg ~ DailyNews * Discrim_5.d + DayWeek.d + Dep_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(Dep_agg ~ DailyNews * Discrim_6.d + DayWeek.d + Dep_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(Dep_agg ~ DailyNews * Discrim_7.d + DayWeek.d + Dep_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(Dep_agg ~ DailyNews * Discrim_all.d + DayWeek.d + Dep_agg_prevDay + (1|SubID), data = dat) %>% summary()
lmer(Dep_agg ~ DailyNews * Discrim_all_norum.d + DayWeek.d + Dep_agg_prevDay + (1|SubID), data = dat) %>% summary()

# need to separate between/within effects??
